...
function Footer() {
    return (
        <footer className='bg-[#0b0f0a] text-white border-t border-green-500/30'>
            {/* Main Footer */}
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-12 mb-12'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-4 mt-6'>
                            <a href='#' className='bg-white/10 hover:bg-white/20 w-10 h-10 rounded-full flex items-center justify-center transition border border-white/10'>
                    ...
                    <div>
                        ...
                        <ul className='space-y-3'>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Home</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Services</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>About Us</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Blog</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className='space-y-3'>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Crop Monitoring</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Field Mapping</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Precision Agriculture</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Consultancy</a></li>
                            <li><a href='#' className='text-gray-400 hover:text-lime-300 transition'>Support</a></li>
                        </ul>
                    </div>
